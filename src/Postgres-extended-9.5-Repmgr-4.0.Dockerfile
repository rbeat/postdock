...
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/r/repmgr/repmgr-common_4.0.6-2.pgdg80%2B1_all.deb" 
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/r/repmgr/postgresql-$PG_MAJOR-repmgr_4.0.6-2.pgdg80%2B1_amd64.deb" 
