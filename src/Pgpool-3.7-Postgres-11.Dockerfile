...
RUN  wget -q --no-check-certificate https://www.postgresql.org/media/keys/ACCC4CF8.asc -O - | apt-key add - && \
...
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/p/pgpool2/libpgpool0_3.7.5-2.pgdg%2B1_amd64.deb.deb" "libpgpool0"
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/p/pgpool2/pgpool2_3.7.5-2.pgdg90%2B1_amd64.deb" "pgpool2"
